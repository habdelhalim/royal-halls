...
class CustomerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .post("/api/customers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "customerName":"SAMPLE_TEXT", "identityId":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "country":"SAMPLE_TEXT", "mobile":"SAMPLE_TEXT", "telephone":"SAMPLE_TEXT", "nationality":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
