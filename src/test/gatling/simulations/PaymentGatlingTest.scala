...
class PaymentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Payment entity")
        ...
        .repeat(2) {
            ...
            .post("/api/payments")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "paymentType":null, "paymentAmount":null, "paymentDueDate":"2020-01-01T00:00:00.000Z", "paymentStatus":null, "chequeNo":"SAMPLE_TEXT", "bankName":"SAMPLE_TEXT", "creationDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
