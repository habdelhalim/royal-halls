...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "royalhalls@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "royalhalls API";

        private String description = "royalhalls API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "royalhalls";
